...
$("#csv").click(function() {
 	    $.ajax({
            ...
            success: function(data) {
                    var finalVal = ''
                    finalVal =  'Activity_type,Center,Role,Activities Completed,experience_challenge,challenge_handle_situation,conducted by,could_improved,curriculum,end_date,end_time,feedback,hashtag,logdate,logtime,student_performance,start_date,start_time,student_objectives,todays_objective,topics_covered,upload,went_well' + '\n';
